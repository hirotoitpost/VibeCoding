...
export interface VibeCodingTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "INITIAL_SUPPLY"
      | "allowance"
...
export interface VibeCodingToken extends BaseContract {
  connect(runner?: ContractRunner | null): VibeCodingToken;
  waitForDeployment(): Promise<this>;

  interface: VibeCodingTokenInterface;
